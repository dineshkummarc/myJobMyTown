...
<hr>
    ...
    <img src="images/signup1.png" class="img-fluid" style="margin-top:100px; -webkit-filter: drop-shadow(10px 10px 10px #ccc);
  filter: drop-shadow(5px 5px 5px #ccc);">
 
  </div>


  <div class="col-md-8 p-4 " style="height:630px; " >
<form>
...
<br>
     <a href="smc.php" class="btn btn-lg btn-primary btn-block  sab-btn2">Sign In</a>
         ...
         <p class="text-right mt-1">already a user <a href="#">Sign In</a></p>
