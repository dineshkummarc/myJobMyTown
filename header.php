...
-->
                    <span style="cursor:pointer" class="nav-link" onclick="openLg()"> Login</span>
                    <span style="cursor:pointer" class="nav-link" onclick="openSu()"> Signup</span>
    ...
    <div class="row">
        <div class="col-md-4" style="background-color:#2874F0; ">
            ...
            <p class="ml-3 text-white text-justify">
                Lorem Ipsum is simply dummy text of the printing and typesetting sateesh
            </p>
        ...
        <div class="col-md-8 " style="height:620px;">
            <form class="mt-3 ml-3">
                ...
                <center>
                    <a href="#">
                        <p class="sab-bottom-text2">Forgotton your password?</p>
                    </a>
                </center>
                <center>
                    <p class="sab-bottom-text2 text-primary sualert">Create an account</p>
                </center>
...
<div id="lg" class="overlay">





    <div class="col-md-6 offset-md-3 bg-white" style="position:relative;top:10%;
    width: 100%;
    ">
        <div class="row">
            <div class="col-md-4" style="background-color:#2874F0; ">
            ...
            <div class="col-md-8">
                <a href="javascript:void(0)" class="closebtn" onclick="closeLg()">&times;</a><br><br>
                <form class="mt-3 ml-3">
                    <div class="form-group sab-form-group2">
                        <label for="email">Email:</label>
                        <input type="E-mail" class="form-control sab-form-control" id="email" placeholder="E-mail id" required="">
                    ...
                    <center>
                        <p class="sab-bottom-text2 text-primary " onclick="closeLg(); openSu()">Create an account</p>
                    </center>
...
<div id="su" class="overlay">
  ...
  filter: drop-shadow(15px 15px 15px #222);  ">
            ...
            <div class="col-md-8 p-3">
                <a href="javascript:void(0)" class="closebtn" onclick="closeSu()">&times;</a><br><br>
    ...
    <option value="Safari"></option>
                    ...
                    <br>
                    <a href="smc.php" class="btn btn-lg btn-primary btn-block  sab-btn2">Sign up</a>

                    <p class="text-right mt-1">already a user <span class="text-primary" onclick="closeSu(); openLg()">Sign In</span></p>
